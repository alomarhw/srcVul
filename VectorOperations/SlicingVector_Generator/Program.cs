...
public class DatabaseManager
{
	...
	public void InsertVectorData(string methodName, string variableName, double SC, double SCvg, double SI, double SS)
	{
		Console.WriteLine($"Inserting: Method={methodName}, Variable={variableName}, SC={SC}, SCvg={SCvg}, SI={SI}, SS={SS}");

		string insertQuery = @"
            INSERT INTO VectorData (MethodName, VariableName, SC, SCvg, SI, SS)
